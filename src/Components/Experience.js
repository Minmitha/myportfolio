                        ...
                        <div className="education-card flex items-center justify-center w-full sm:w-[600px] h-[200px]">
                            <div className="basis-1/4 flex flex-col items-center">
                                <span className="flex items-center justify-center w-10 h-10 bg-[#FFB400] rounded-full transition-all duration-700 ease-in-out group-hover:bg-[#FFB600]">
                                    <img src="./img/asset/job.svg" className="w-5 h-5" alt="job icon" />
                                </span>
                ...
                <div className="">
                    <div className="flex flex-col gap-4">
                        <div className="education-card flex items-center justify-center w-full sm:w-[600px] h-[200px]">
                            <div className="basis-1/4 flex flex-col items-center">
                                <span className="flex items-center justify-center w-10 h-10 bg-[#FFB400] rounded-full transition-all duration-700 ease-in-out group-hover:bg-[#FFB600]">
                                    <img src="./img/asset/education.svg" className="w-5 h-5" alt="education icon" />
                                </span>
                                <div className="w-[2px] h-[100px] bg-[#252525]"></div>
                            </div>
                            <div className="flex flex-col gap-2 mt-4">
                        ...
                        <div className="education-card flex items-center justify-center w-full sm:w-[600px] h-[200px]">
                            ...
                            <div className="flex flex-col gap-2 mt-4">
                                <span className="text-sm font-semibold text-white rounded-lg bg-[#252525] w-48 opacity-80 text-center mt-2">June, 2016 - March, 2018</span>
                                <span className="uppercase text-white font-medium text-lg">Class XII - TV Sundram Matric Higher Secondary School</span>
                                <p className="text-lg text-white">Completed Class XII with a focus on Science.</p>
                            </div>
                        </div>
                        ...
                        <div className="education-card flex items-center justify-center w-full sm:w-[600px] h-[200px]">
                            ...
                            <div className="flex flex-col gap-2 mt-4">
                                <span className="text-sm font-semibold text-white rounded-lg bg-[#252525] w-48 opacity-80 text-center mt-2">June, 2014 - March, 2016</span>
                                <span className="uppercase text-white font-medium text-lg">Class X - TV Sundram Matric Higher Secondary School</span>
                                <p className="text-lg text-white">Completed Class X with a focus on general studies.</p>
                            </div>
                        </div>
                    </div>
                </div>
