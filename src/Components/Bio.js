        ...
        <>
            <div className="flex h-screen bg-[#111111]">
                <div className="flex flex-row relative fixed inset-0 overflow-hidden">
                    ...
                    <div className="flex flex-grow items-center justify-center relative p-9 ">
                ...
                <div className="text-left flex flex-col justify-center w-full sm:w-3/4 lg:w-1/2 p-4 sm:pl-40 lg:pl-52">
                    <div className="hidden sm:block md:block lg:hidden p-12">
                        <img
                            alt="name"
                            src="./img/mini2.png"
                    ...
                    <p className="text-white text-4xl md:text-5xl lg:text-6xl mt-4 font-bold">SOFTWARE ENGINEER</p>
                    ...
                    <button type="button" class="flex items-center justify-between text-[#FFB400] w-60 h-14 bg-black border-[1.5px] border-[#FFB400] hover:bg-[#FFB400] hover:text-black focus:outline-none font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-4 dark:focus:ring-yellow-900 transition-colors relative overflow-hidden">
                        <span class="text-white pl-5 text-base">MORE ABOUT ME</span>
                        <div class="absolute right-0 top-0 bottom-0 flex items-center justify-center w-14 h-14 bg-[#FFB400] rounded-full hover:bg-[#FFB400] transition-colors">
