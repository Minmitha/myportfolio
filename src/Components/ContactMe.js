                        ...
                        <div className="basis-3/4 flex flex-col items-center justify-center">
                            <form className="w-full max-w-[800px] flex flex-col gap-4">
                                <div className="flex gap-4">
                                    <input
                                        className="bg-[#252525] h-10 flex-1 text-center rounded-full focus:outline-none focus:ring-1 focus:ring-yellow-500 focus:border-[#FFB400] caret-white"
                                        type="text"
                                ...
                                <textarea
                                    className="bg-[#252525] h-[200px] w-full text-left rounded-xl p-4 focus:outline-none focus:ring-1 focus:ring-yellow-500 focus:border-[#FFB400] caret-white"
