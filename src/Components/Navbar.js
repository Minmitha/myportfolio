    ...
    return (
        <>
            ...
            <div className="flex items-center rounded-full  group transition-all duration-700 ease-in-out hover:bg-[#FFB600]">
                ...
                <button className="flex items-center justify-center w-14 h-14  rounded-full  bg-[#2B2A2A] transition-all duration-700 ease-in-out group-hover:bg-[#FFB600]" onClick={() => navigate('/portfolio')}>
            ...
            <div className="flex items-center rounded-full  group transition-all duration-700 ease-in-out hover:bg-[#FFB600]">
                ...
                <button className="flex items-center justify-center w-14 h-14  rounded-full  bg-[#2B2A2A] transition-all duration-700 ease-in-out group-hover:bg-[#FFB600]" onClick={() => navigate('/contactme')}>
