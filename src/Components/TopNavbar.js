            ...
            <nav className="bg-[#111111] border-gray-200 dark:bg-gray-900 dark:border-gray-700 fixed w-full z-10 md:hidden">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className={`${isNavOpen ? "block" : "hidden"} w-full`}>
                        <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-[#111111] md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <Link
                                    to="/"
                                    className={`block py-2 px-3 text-white rounded ${
                                        isActive("/") ? "bg-[#FFB400]" : "hover:bg-[#FFB400]"
                                    } md:hover:bg-transparent md:p-0 dark:bg-blue-600 md:dark:bg-transparent`}
                            ...
                            <li>
                                <Link
                                    ...
                                    } md:hover:bg-transparent md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 md:dark:hover:bg-transparent`}
                                >
                                    About
                                </Link>
                            </li>
